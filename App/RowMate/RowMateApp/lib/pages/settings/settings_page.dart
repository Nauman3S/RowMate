...
import 'package:rowmate/bloc/settings/settings.dart';
...
class SettingsPageState extends State<SettingsPage> {
  final Guid _SYSTEM_SERVICE_GUID =
      Guid('00000000-61c8-471e-94f3-5050570167b2');
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (_) =>
            SettingsBloc(bleBloc.getServiceByGuid(_SYSTEM_SERVICE_GUID))
