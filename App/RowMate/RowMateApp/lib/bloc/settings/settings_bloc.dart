...
import 'package:rowmate/bloc/settings/settings_event.dart';
import 'package:rowmate/bloc/settings/settings_state.dart';

class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  final Guid _IP_ADDRESS_CHARACTERISTIC_GUID =
      Guid('00000001-61c8-471e-94f3-5050570167b2');
  final Guid _SHUTDOWN_CHARACTERISTIC_GUID =
      Guid('00000002-61c8-471e-94f3-5050570167b2');
  ...
  Stream<SettingsState> _mapShouldGetIpAddress() async* {
    final characteristic = _bleService.characteristics
        .firstWhere((c) => c.uuid == _IP_ADDRESS_CHARACTERISTIC_GUID);
  ...
  Stream<SettingsState> _mapShouldShutdown() async* {
    final characteristic = _bleService.characteristics
        .firstWhere((c) => c.uuid == _SHUTDOWN_CHARACTERISTIC_GUID);
