...
import 'package:rowmate/bloc/city/city_event.dart';
import 'package:rowmate/bloc/city/city_state.dart';

class CityBloc extends Bloc<CityEvent, CityState> {
  final Guid _CITY_ID_CHARACTERISTIC_GUID =
      Guid('00000003-8cb1-44ce-9a66-001dca0941a6');
  ...
  Stream<CityState> _mapChangeCity(ChangeCity event) async* {
    final characteristic = _bleService.characteristics
        .firstWhere((c) => c.uuid == _CITY_ID_CHARACTERISTIC_GUID);
