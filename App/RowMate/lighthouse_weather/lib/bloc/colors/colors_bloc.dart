...
import 'package:rowmate/bloc/colors/colors_event.dart';
import 'package:rowmate/bloc/colors/colors_state.dart';

class ColorsBloc extends Bloc<ColorsEvent, ColorsState> {
  final Guid _RGB_COLOR_CHARACTERISTIC_GUID =
      Guid('00000001-8194-4451-aaf5-7874c7c16a27');
  ...
  Stream<ColorsState> _mapChangeColor(ChangeColors event) async* {
    final characteristic = _bleService.characteristics
        .firstWhere((c) => c.uuid == _RGB_COLOR_CHARACTERISTIC_GUID);
